...
function About() {
  return (
    <div className="h-[60rem]  md:h-[35rem] w-full rounded-md flex md:items-center md:justify-center antialiased bg-grid-white/[0.02] relative overflow-hidden">
      <Spotlight
        className="-top-40 left-0 md:left-60 md:-top-20"
        fill="white"
      />
      <div className=" p-4 max-w-7xl  mx-auto relative z-10  w-full pt-20 md:pt-0">
        <h1 className="text-3xl md:text-5xl font-bold text-center bg-clip-text text-transparent bg-gradient-to-b from-neutral-500 to-neutral-700 bg-opacity-50">
          About me <br /> <span className="text-3xl">👋 Hi there! I am Aman Koahre.</span>
        </h1>
        <p className="mt-4 font-normal text-base  text-neutral-600 dark:text-neutral-300 max-w-4xl text-start mx-auto">
