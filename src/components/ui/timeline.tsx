...
export const Timeline = ({ data }: { data: TimelineEntry[] }) => {
  ...
  return (
    <div
      ...
      ref={containerRef}
    >
      <div className="max-w-[800px] mx-auto py-6 md:py-20 px-8 md:px-8 lg:px-10">
      ...
      <div ref={ref} className="relative max-w-[800px] mx-auto pb-20">
        {data.map((item, index) => (
          <div
            key={index}
          ...
          >
            <div className="sticky flex flex-col md:flex-row z-40 items-center top-40 self-start max-w-xs lg:max-w-sm md:w-full">
              ...
              <h3 className="hidden md:block text-lg md:pl-20 md:text-xl font-bold text-neutral-500 dark:text-neutral-500 ">
                {item.title}
              </h3>
            </div>
