  ...
  return (
    <nav
      ...
      className={`${isScrolled && "bg-opacity-[0.5] shadow-md drop-shadow-lg"
        } font-medium duration-500 bg-opacity-50 transition-all linear z-40  dark:text-white w-[90%] md:w-[75%] lg:w-[60%] xl:w-[55%]  max-w-6xl  mx-auto bg-gray-100 dark:bg-[#35353544] ${open && "dark:bg-[#000] bg-opacity-100"
        ...
        <div className="select-none order-2 md:order-1 cursor-pointer flex items-center text-gray-800">
          <div className="cursor-pointer flex items-center">
            <Link href="/" className="flex items-center space-x-1">
              <img src="/icons/logo.png" alt="Logo" className="h-9 rounded-full" />
